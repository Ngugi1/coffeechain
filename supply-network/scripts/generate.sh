...
../bin/configtxgen -configPath ./supply-network -profile SupplyChannel -outputCreateChannelTx ./supply-network/channel-artifacts/channel.tx -channelID mychannel
 ...
 OPTS="-i"
 cd $CURRENT_DIR
 cd ./supply-network/crypto-config/peerOrganizations/cooperative.coffeechain.com/ca/
 PRIV_KEY=$(ls *_sk)
 cd $CURRENT_DIR
 cd ./supply-network/base
 ...
 cd $CURRENT_DIR
 cd ./supply-network/crypto-config/peerOrganizations/transporter.coffeechain.com/ca/
 PRIV_KEY=$(ls *_sk)
 cd $CURRENT_DIR
 cd ./supply-network/base
 ...
 cd $CURRENT_DIR
 cd ./supply-network/crypto-config/peerOrganizations/miller.coffeechain.com/ca/
 PRIV_KEY=$(ls *_sk)
 cd $CURRENT_DIR
 cd ./supply-network/base
 ...
 cd $CURRENT_DIR
 cd ./supply-network/crypto-config/peerOrganizations/insurance.coffeechain.com/ca/
 PRIV_KEY=$(ls *_sk)
 cd $CURRENT_DIR
 cd ./supply-network/base
